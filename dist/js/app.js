...
/* harmony import */ var nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! nice-select2/dist/js/nice-select2 */ "./node_modules/nice-select2/dist/js/nice-select2.js");
/* harmony import */ var nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1__);
...
function modal_request(_x, _x2, _x3) {
  return _modal_request.apply(this, arguments);
}
function _modal_request() {
  _modal_request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url, method, payload) {
    var options, req, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            options = method === "GET" && payload === "" ? {} : {
              method: method,
              body: payload,
              headers: {
...
window.ca.display_normal_modal = function (options) {
  ...
  var title = options["data-modal-title"];
  var body = options["data-modal-body"];
  var icon = options["data-modal-icon"];
  var hide_icon = options["data-modal-hidden-icon"];
  var button_text = options["data-modal-button-text"];
  var button_dismiss_text = options["data-modal-button-dismiss-text"];
  var href = options["data-modal-href"];
  var method = options["data-modal-method"];
  var payload = options["data-modal-payload"];
  var modal = document.getElementById(type + "_modal");
  ...
  var modal_instance = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(modal, {});
  modal_instance.show();
  if (type === "confirm") {
    modal_ok_button.addEventListener("click", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                _context.next = 3;
                return modal_request(href, method, payload);
              case 3:
                toggle_modal(modal);
              case 4:
              case "end":
...
function normal_modal(event, modal) {
  ...
  var type = button.getAttribute("data-modal-type");
  ...
  var href = button.getAttribute("data-modal-href");
  var method = button.getAttribute("data-modal-method");
  var payload = button.getAttribute("data-modal-payload");
  var modal_title = modal.querySelector(".modal-title");
  var modal_body = modal.querySelector(".modal-body .message");
  var modal_icon_wrapper = modal.querySelector(".modal-icon-wrapper");
  var modal_icon = modal.querySelector(".modal-icon");
...
if (confirm_modal) {
  confirm_modal.addEventListener("show.bs.modal", function (event) {
    return normal_modal(event, confirm_modal);
  });
}
if (info_modal) {
...
Array.from(document.querySelectorAll(".nice-select, .ca-select")).forEach(function (element) {
  var is_search = element.classList.contains("ca-select-search");
  var placeholder = element.dataset.placeholder || null;
  var search_placeholder = element.dataset.searchPlaceholder;
  var config = {};
  ...
  var s = new (nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1___default())(element, config);
  var dropdown = s.dropdown.querySelector(".nice-select-dropdown");
  var select = s.el;
  var is_full_width = select.classList.contains("ca-select-fullwidth");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcanapply_design_system"] = self["webpackChunkcanapply_design_system"] || [];
