...
window.ca.display_normal_modal = function (options) {
  ...
  var size = options["data-modal-size"];
  ...
  var hide_close = options["data-modal-hidden-close"];
  var hide_footer = options["data-modal-hidden-footer"];
...
function normal_modal(event, modal) {
  ...
  var size = button.getAttribute("data-modal-size");
  ...
  var hide_close = button.getAttribute("data-modal-hidden-close");
  var hide_footer = button.getAttribute("data-modal-hidden-footer");
...
Array.from(phone_inputs).forEach(function (input) {
  ...
  var options = input.dataset.options === undefined ? [] : JSON.parse(input.dataset.options);
  intl_tel_input__WEBPACK_IMPORTED_MODULE_2___default()(input, _objectSpread(_objectSpread({}, options), {}, {
...
Array.from(document.querySelectorAll(".nice-select, .ca-select")).forEach(function (element) {
  ...
  var placeholder = element.dataset.placeholder || undefined;
  var dropdown_max_height = element.dataset.dropdownMaxHeight || undefined;
  ...
  var select = s.el;
  var current = s.dropdown.querySelector(".current");
  current.classList.add("d-block", "w-100");
  var is_full_width = select.classList.contains("ca-select-fullwidth");
  if (dropdown_max_height) {
    var list = s.dropdown.querySelector('.list');
    list.style.maxHeight = "".concat(dropdown_max_height, "px");
