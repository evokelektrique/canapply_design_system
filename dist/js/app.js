...
Array.from(document.querySelectorAll(".nice-select-search")).forEach(function (select) {
  var s = new (nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1___default())(select, {
    searchable: true
  });
});
Array.from(document.querySelectorAll(".nice-select")).forEach(function (select) {
  var s = new (nice_select2_dist_js_nice_select2__WEBPACK_IMPORTED_MODULE_1___default())(select, {
    searchable: false
  });
